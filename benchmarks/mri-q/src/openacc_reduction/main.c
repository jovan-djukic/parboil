...
int main ( int argc, char *argv[] ) {
   ...
   * on the command line */
    ...
    #pragma acc data copyout(Qr[0:numX], Qi[0:numX]) copyin(phiR[0:numK], phiI[0:numK], kx[0:numK], ky[0:numK], kz[0:numK], x[0:numX], y[0:numX], z[0:numX]) create(phiMag[0:numK], kVals[0:numK])
    {
